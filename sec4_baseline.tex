...
\caption{Work flow of Temporal Replication and Parallel Mining (TRPM). (a)(b) correspond to the first map-reduce cycle which clusters objects in each snapshot;  (c)(d) correspond to the second map-reduce cycle, which uses TRPM to detect GCMP in parallel.}
\label{fig:trm}
\end{figure*}
