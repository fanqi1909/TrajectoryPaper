...
In the revision, we add Section 2.5 to accredit the origin of \emph{gap} concept
...
are nontrivial to be generalized. Since our GCMP model as well as solutions
do not leverage domain knowledge, we can support
pattern discovery in a broader context. We add the discussion in Section 2.3.
}