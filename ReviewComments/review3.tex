...
we wish to focus on solving how to design parallel GCMP mining algorithms.
%to provide a general parallel framework which does not tie to Spark.
Nevertheless, we are in progress to develop and open-source 
a better SPARE version with Spark-tailored optimization. 
...
\response{ We use all 16 cores in a single node in our settings. We revise the description in Section 6.2.3.
} 
