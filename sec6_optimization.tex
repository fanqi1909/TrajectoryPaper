...
%Our goal of edge simplification is to, given a time sequence $T$, find a 
%subsequence of $T' \subseteq T$, such that $T'$ conforms to $K,L,G$. And we
...
\begin{theorem}[Temporal Monotonicity]
