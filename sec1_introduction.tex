...
\hline 
\end{tabular} 
\caption{Constraints and complexity of co-movement patterns. The time complexity indicates the performance in the worst case, where $|\mathbb{O}|$ is the total number of objects, $|\mathbb{T}|$ is the number of descritized timestamps and $M$ is the minimum cluster cardinality. }
